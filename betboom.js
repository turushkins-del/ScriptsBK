...
if (allMarketGroups[0].classList[0] != allMarketGroups[allMarketGroups.length-1].classList[0]) {
    allMarketGroups[0].remove()
    allMarketGroups = document.querySelectorAll('section[class^="bb-"')
} 
